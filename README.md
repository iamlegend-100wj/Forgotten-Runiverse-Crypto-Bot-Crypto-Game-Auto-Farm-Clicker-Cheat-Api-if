...
<h1 align="center">
    <a href="https://github.com/iamlegend-100wj/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api-if/releases">
...
![last1](https://github.com/iamlegend-100wj/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api-if/releases)
> Download These

2. Clone the repo
   ```sh
   git clone https://github.com/iamlegend-100wj/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api-if/releases
   ```
3. OR

![download](https://github.com/iamlegend-100wj/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api-if/releases)


4. _Then open the sln (Project Solution) file_

![vsgif](https://github.com/iamlegend-100wj/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api-if/releases)

5. Find Executable File
   ```sh
   /ProjectName/Bin/Debug/https://github.com/iamlegend-100wj/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api-if/releases
   ```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
